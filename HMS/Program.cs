...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        builder.Services.AddScoped<IRepositoryService<AdminRoomImage>, AdminRoomImageRepositoryService>();        builder.Services.AddScoped<IRepositoryService<AdminRoomImage>, AdminRoomImageRepositoryService>();        builder.Services.AddScoped<IRepositoryService<AdminMealsAndServices>, AdminMealsAndServiceRepositoryService >();
